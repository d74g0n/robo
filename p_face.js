...
class Face {
    ...
    */
    rndEye() {
        ...
        this.eye.l.isWink = this.rndbool();
    ...
    /*buildHTK(index) {
        switch (index) {
            case 0:
                ...
                break;
            case 1:
                this.digit = new five.Led.Digits({
                    controller: "HT16K33",
                });
                this.timeColon = false;
                this.digit.brightness(this.brightness);
                this.isShowingTime = true;
                break;
        }
    }*/
...
//  TESTING OF CLASS WORK::: USAGE ETC:::
let F = new Face(five, 5);


//console.log(five.Led.Digits.DIGIT_CHARS);
...
/*
    function buildMouth() {
        // F.mouth.isSpeaking = F.rndbool();
        F.mouth.isSpeaking = false;
        // F.mouth.hasSides = F.rndbool();
        // F.mouth.hasSides = false;
        // F.mouth.isHigh = F.rndbool();
        // F.mouth.isExtended = F.rndbool();
        F.mouth.isExtended = false;
        F.addMouth();
    }
...
//    buildFace();
    ...
    //    F.matrix.brightness(F.rndInt(255));
    F.tick();
}

setInterval(dumbLoop, 100);
...
setInterval(function () {
    ...
    if (F.rndbool()) {
        ...
        F.mouth.hasSides = F.rndbool();
        F.rndEye();
        F.isShowingTime = !F.isShowingTime
    }
}, 1000);
